...
video_put_args.add_argument("likes", type=str, help="Likes of the video are required", required=True)
...
class Video(Resource):
    ...
    def patch(self, video_id):
        ...
        if not video:
            abort(404, message="Could not find a video with this id...")
        if args['name']:
    ...
    def delete(self, video_id):
        ...
        db.session.commit()
        return {"message": f"video {video_id} was successfuly deleted"}, 204
